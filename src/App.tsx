    ...
    <div className="font-sans text-gray-900 bg-white" id="top">
      ...
      <div className="bg-black text-white text-xs sm:text-sm">
        <div className="max-w-6xl mx-auto px-4 py-2 flex items-center justify-between gap-3">
          ...
          <a
            href="#reviews"
            className="inline-flex items-center gap-2 rounded-full border border-white/30 px-3 py-1.5 text-white/90 hover:text-white hover:border-white/60 transition"
          >
            <span className="text-yellow-400">★★★★★</span>
            <span className="hidden sm:inline">Reviews</span>
          </a>

          {/* Middle: Locations (not clickable) */}
          <div className="text-center flex-1 text-white/90 font-medium truncate">
          ...
          <a
            href="#quote"
            className="inline-flex items-center justify-center rounded-full bg-lime-400 px-4 py-1.5 text-xs sm:text-sm font-semibold text-black hover:bg-lime-300 transition"
          >
            Free Quote
          </a>
        </div>
